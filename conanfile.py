...
class ATACControllerViewPluginConan(ConanFile):
    ...
    name = "ATACControllerViewPlugin"
    description = """Plugins for displaying ATACControllerView in ManiVaultStudio."""
    topics = ("hdps", "plugin", "image data", "loading")
    url = "https://github.com/ManiVaultStudio/ATACControllerViewPlugin"
    ...
    scm = {
        "type": "git",
        "subfolder": "hdps/ATACControllerViewPlugin",
        "url": "auto",
        "revision": "auto",
    }
    ...
    def _configure_cmake(self):
        cmake = CMake(self)
        cmake.configure(build_script_folder="hdps/ATACControllerViewPlugin")
        cmake.verbose = True
        return cmake
